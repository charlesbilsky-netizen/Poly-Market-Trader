...
- **API Keys:** If you choose to use advanced AI features (e.g., Gemini, OpenAI, xAI), you may input your own API keys. These keys are stored securely in your device's local storage and are sent directly to the respective third-party service providers. We never see or have access to your API keys.
...
## 5. Security
We take reasonable measures to protect the information stored locally on your device by using Android's standard secure storage mechanisms. However, the security of your device is your responsibility. We recommend using a device lock and keeping your operating system up to date.
